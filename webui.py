    ...
    with gr.Row():
        with gr.Column(scale=2):
            ...
            with gr.Row(elem_classes='advanced_check_row'):
                input_image_checkbox = gr.Checkbox(label='Input Image', value=False, container=False,visible=True, elem_classes='min_check')
        ...
        with gr.Column(scale=1, visible=modules.config.default_advanced_checkbox) as advanced_column:
            with gr.Tab(label='Setting'):
                ...
                image_number = gr.Slider(label='Image Number', minimum=1, maximum=1, step=1, value=modules.config.default_image_number)
        ...
        def trigger_describe(mode, img, visible=True):
